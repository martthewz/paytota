...
class PaytotaApi {
	...
	public function __construct($brandId, $apiKey, $base = 'https://gate.paytota.com/api/v1/', $config = []) {
	...
	/**
	 * 
	 * @param \Paytota\Model\Purchase $purchase
	 * @return \Paytota\Model\Purchase
	 */
